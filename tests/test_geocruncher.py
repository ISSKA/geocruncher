...
def test_geocruncher():
    main.run_geocruncher('intersections', ['', '', 'tests/dummy_project/sections.json',
                         'tests/dummy_project/geocruncher_project.xml', 'tests/dummy_project/geocruncher_dem.asc', '', 'test_output.json'])
...
def test_mesh_generation():
    ...
    os.mkdir(out_dir)
    main.run_geocruncher(
        'meshes', ['', '', configuration_file, project_file, dem_file, out_dir])
...
def test_slice():
    ...
    main.run_geocruncher(
        'intersections', ['', '', slice_file, project_file, dem_file, '', out_file])
