...
class TestLoadProjectBox:
    ...
    def test_potentials_gwb_cells_are_one(self):
        ...
        result = load_project_box(
            box, stratigraphy, {"x": 1, "y": 1, "z": 2}, voxels, [1]
        )
...
class TestLoadWaterTables:
    ...
    def test_each_gwb_produces_separate_surface(self):
        ...
        assert surfaces[1].surface.get_nb_pts() > 0
        assert surfaces[2].surface.get_nb_pts() > 0
