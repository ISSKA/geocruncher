...
def test_sliceAroundYAxisTestPointsRegularly():
    ...
    def fakeRank(l):
        ...
        return 0
    Slice.output([0, 0], [10, 29], [0, 19], 20, fakeRank, [1, 1], False, [], [], 0)
...
def test_sliceForSlopOfOneTestPointsRegularly():
    ...
    def fakeRank(l):
        tested_points.append(l)
        return 0
    Slice.output([0, 19], [10, 29], [0, 19], 20, fakeRank, [1, 1], False, [], [], 0)
...
def test_sliceForSlopeOfZeroTestPointsRegularly():
    ...
    def fakeRank(l):
        tested_points.append(l)
        return 0
    Slice.output([0, 19], [10, 10], [0, 19], 20, fakeRank, [1, 1], False, [], [], 0)
    for x in range(0, 20):
        for z in range(0, 20):
