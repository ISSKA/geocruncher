...
PROFILER_INTERSECTIONS_V4 = VkProfilerSettings(
    ...
    ['start_time', 'num_series', 'num_units', 'num_finite_faults', 'num_infinite_faults', 'num_contact_data', 'num_dips', 'resolution', 'num_sections', 'compute_map', 'num_springs', 'num_drillholes', 'num_gwb_parts'])
