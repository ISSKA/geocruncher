...
```bash
curl -F "data=<tests/fixtures/dummy_project/sections.json" -F xml=@tests/fixtures/dummy_project/geocruncher_project.xml -F dem=@tests/fixtures/dummy_project/geocruncher_dem.asc http://127.0.0.1:5000/compute/intersections
```
